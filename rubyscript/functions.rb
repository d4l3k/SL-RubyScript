class SLObject
	...
	def llSetForce ll_force, ll_local
		return send_packet "llSetForce", [ll_force, ll_local]
	end
	def llSetForceAndTorque ll_force, ll_torque, ll_local
		return send_packet "llSetForceAndTorque", [ll_force, ll_torque, ll_local]
	end
	def llSetHoverHeight ll_height, ll_water, ll_tau
		return send_packet "llSetHoverHeight", [ll_height, ll_water, ll_tau]
	end
	def llSetInventoryPermMask ll_item, ll_mask, ll_value
		return send_packet "llSetInventoryPermMask", [ll_item, ll_mask, ll_value]
	end
	def llSetKeyframedMotion ll_keyframes, ll_options
		return send_packet "llSetKeyframedMotion", [ll_keyframes, ll_options]
	end
	def llSetLinkAlpha ll_linknumber, ll_alpha, ll_face
		return send_packet "llSetLinkAlpha", [ll_linknumber, ll_alpha, ll_face]
	end
	def llSetLinkCamera ll_link, ll_eye, ll_at
		return send_packet "llSetLinkCamera", [ll_link, ll_eye, ll_at]
	end
	def llSetLinkColor ll_linknumber, ll_color, ll_face
		return send_packet "llSetLinkColor", [ll_linknumber, ll_color, ll_face]
	end
	def llSetLinkMedia ll_link, ll_face, ll_params
		return send_packet "llSetLinkMedia", [ll_link, ll_face, ll_params]
	end
	def llSetLinkPrimitiveParams ll_linknumber, ll_rules
		return send_packet "llSetLinkPrimitiveParams", [ll_linknumber, ll_rules]
	end
	def llSetLinkPrimitiveParamsFast ll_linknumber, ll_rules
		return send_packet "llSetLinkPrimitiveParamsFast", [ll_linknumber, ll_rules]
	end
	def llSetLinkTexture ll_linknumber, ll_texture, ll_face
		return send_packet "llSetLinkTexture", [ll_linknumber, ll_texture, ll_face]
	end
	def llSetLinkTextureAnim ll_link, ll_mode, ll_face, ll_sizex, ll_sizey, ll_start, ll_length, ll_rate
		return send_packet "llSetLinkTextureAnim", [ll_link, ll_mode, ll_face, ll_sizex, ll_sizey, ll_start, ll_length, ll_rate]
	end
	def llSetLocalRot ll_rot
		return send_packet "llSetLocalRot", [ll_rot]
	end
	def llSetMemoryLimit ll_limit
		return send_packet "llSetMemoryLimit", [ll_limit]
	end
	def llSetObjectDesc ll_description
		return send_packet "llSetObjectDesc", [ll_description]
	end
	def llSetObjectName ll_name
		return send_packet "llSetObjectName", [ll_name]
	end
	def llSetObjectPermMask ll_mask, ll_value
		return send_packet "llSetObjectPermMask", [ll_mask, ll_value]
	end
	def llSetParcelMusicURL ll_url
		return send_packet "llSetParcelMusicURL", [ll_url]
	end
	def llSetPayPrice ll_price, ll_quick_pay_buttons
		return send_packet "llSetPayPrice", [ll_price, ll_quick_pay_buttons]
	end
	def llSetPos ll_pos
		return send_packet "llSetPos", [ll_pos]
	end
	def llSetPrimMediaParams ll_face, ll_params
		return send_packet "llSetPrimMediaParams", [ll_face, ll_params]
	end
	def llSetPrimURL ll_url
		return send_packet "llSetPrimURL", [ll_url]
	end
	def llSetPrimitiveParams ll_rules
		return send_packet "llSetPrimitiveParams", [ll_rules]
	end
	def llSetRegionPos ll_position
		return send_packet "llSetRegionPos", [ll_position]
	end
	def llSetRemoteScriptAccessPin ll_pin
		return send_packet "llSetRemoteScriptAccessPin", [ll_pin]
	end
	def llSetRot ll_rot
		return send_packet "llSetRot", [ll_rot]
	end
	def llSetScale ll_size
		return send_packet "llSetScale", [ll_size]
	end
	def llSetScriptState ll_name, ll_run
		return send_packet "llSetScriptState", [ll_name, ll_run]
	end
	def llSetSitText ll_text
		return send_packet "llSetSitText", [ll_text]
	end
	def llSetSoundQueueing ll_queue
		return send_packet "llSetSoundQueueing", [ll_queue]
	end
	def llSetSoundRadius ll_radius
		return send_packet "llSetSoundRadius", [ll_radius]
	end
	def llSetStatus ll_status, ll_value
		return send_packet "llSetStatus", [ll_status, ll_value]
	end
	def llSetText ll_text, ll_color, ll_alpha
		return send_packet "llSetText", [ll_text, ll_color, ll_alpha]
	end
	def llSetTexture ll_texture, ll_face
		return send_packet "llSetTexture", [ll_texture, ll_face]
	end
	def llSetTextureAnim ll_mode, ll_face, ll_sizex, ll_sizey, ll_start, ll_length, ll_rate
		return send_packet "llSetTextureAnim", [ll_mode, ll_face, ll_sizex, ll_sizey, ll_start, ll_length, ll_rate]
	end
	def llSetTimerEvent ll_sec
		return send_packet "llSetTimerEvent", [ll_sec]
	end
	def llSetTorque ll_torque, ll_local
		return send_packet "llSetTorque", [ll_torque, ll_local]
	end
	def llSetTouchText ll_text
		return send_packet "llSetTouchText", [ll_text]
	end
	def llSetVehicleFlags ll_flags
		return send_packet "llSetVehicleFlags", [ll_flags]
	end
	def llSetVehicleFloatParam ll_param, ll_value
		return send_packet "llSetVehicleFloatParam", [ll_param, ll_value]
	end
	def llSetVehicleRotationParam ll_param, ll_rot
		return send_packet "llSetVehicleRotationParam", [ll_param, ll_rot]
	end
	def llSetVehicleType ll_type
		return send_packet "llSetVehicleType", [ll_type]
	end
	def llSetVehicleVectorParam ll_param, ll_vec
		return send_packet "llSetVehicleVectorParam", [ll_param, ll_vec]
	end
	def llSetVelocity ll_force, ll_local
		return send_packet "llSetVelocity", [ll_force, ll_local]
	end
	def llShout ll_channel, ll_msg
		return send_packet "llShout", [ll_channel, ll_msg]
	end
	def llSin ll_theta
		return send_packet "llSin", [ll_theta]
	end
	def llSitTarget ll_offset, ll_rot
		return send_packet "llSitTarget", [ll_offset, ll_rot]
	end
	def llSleep ll_sec
		return send_packet "llSleep", [ll_sec]
	end
	def llSound ll_sound, ll_volume, ll_queue, ll_loop
		return send_packet "llSound", [ll_sound, ll_volume, ll_queue, ll_loop]
	end
	def llSoundPreload ll_sound
		return send_packet "llSoundPreload", [ll_sound]
	end
	def llSqrt ll_val
		return send_packet "llSqrt", [ll_val]
	end
	def llStartAnimation ll_anim
		return send_packet "llStartAnimation", [ll_anim]
	end
	def llStopAnimation ll_anim
		return send_packet "llStopAnimation", [ll_anim]
	end
	def llStopHover 
		return send_packet "llStopHover", []
	end
	def llStopLookAt 
		return send_packet "llStopLookAt", []
	end
	def llStopMoveToTarget 
		return send_packet "llStopMoveToTarget", []
	end
	def llStopPointAt 
		return send_packet "llStopPointAt", []
	end
	def llStopSound 
		return send_packet "llStopSound", []
	end
	def llStringLength ll_str
		return send_packet "llStringLength", [ll_str]
	end
	def llStringToBase64 ll_str
		return send_packet "llStringToBase64", [ll_str]
	end
	def llStringTrim ll_src, ll_type
		return send_packet "llStringTrim", [ll_src, ll_type]
	end
	def llSubStringIndex ll_source, ll_pattern
		return send_packet "llSubStringIndex", [ll_source, ll_pattern]
	end
	def llTakeCamera ll_avatar
		return send_packet "llTakeCamera", [ll_avatar]
	end
	def llTakeControls ll_controls, ll_accept, ll_pass_on
		return send_packet "llTakeControls", [ll_controls, ll_accept, ll_pass_on]
	end
	def llTan ll_theta
		return send_packet "llTan", [ll_theta]
	end
	def llTarget ll_position, ll_range
		return send_packet "llTarget", [ll_position, ll_range]
	end
	def llTargetOmega ll_axis, ll_spinrate, ll_gain
		return send_packet "llTargetOmega", [ll_axis, ll_spinrate, ll_gain]
	end
	def llTargetRemove ll_number
		return send_packet "llTargetRemove", [ll_number]
	end
	def llTeleportAgentHome ll_avatar
		return send_packet "llTeleportAgentHome", [ll_avatar]
	end
	def llTextBox ll_avatar, ll_message, ll_chat_channel
		return send_packet "llTextBox", [ll_avatar, ll_message, ll_chat_channel]
	end
	def llToLower ll_src
		return send_packet "llToLower", [ll_src]
	end
	def llToUpper ll_src
		return send_packet "llToUpper", [ll_src]
	end
	def llTransferLindenDollars ll_destination, ll_amount
		return send_packet "llTransferLindenDollars", [ll_destination, ll_amount]
	end
	def llTriggerSound ll_sound, ll_volume
		return send_packet "llTriggerSound", [ll_sound, ll_volume]
	end
	def llTriggerSoundLimited ll_sound, ll_volume, ll_top_north_east, ll_bottom_south_west
		return send_packet "llTriggerSoundLimited", [ll_sound, ll_volume, ll_top_north_east, ll_bottom_south_west]
	end
	def llUnSit ll_id
		return send_packet "llUnSit", [ll_id]
	end
	def llUnescapeURL ll_url
		return send_packet "llUnescapeURL", [ll_url]
	end
	def llVecDist ll_vec_a, ll_vec_b
		return send_packet "llVecDist", [ll_vec_a, ll_vec_b]
	end
	def llVecMag ll_vec
		return send_packet "llVecMag", [ll_vec]
	end
	def llVecNorm ll_vec
		return send_packet "llVecNorm", [ll_vec]
	end
	def llVolumeDetect ll_detect
		return send_packet "llVolumeDetect", [ll_detect]
	end
	def llWater ll_offset
		return send_packet "llWater", [ll_offset]
	end
	def llWhisper ll_channel, ll_msg
		return send_packet "llWhisper", [ll_channel, ll_msg]
	end
	def llWind ll_offset
		return send_packet "llWind", [ll_offset]
	end
	def llXorBase64Strings ll_s1, ll_s2
		return send_packet "llXorBase64Strings", [ll_s1, ll_s2]
	end
	def llXorBase64StringsCorrect ll_str1, ll_str2
		return send_packet "llXorBase64StringsCorrect", [ll_str1, ll_str2]
	end
end
def llAbs ll_val
...
def llSetForce ll_force, ll_local
	return $objects[0].llSetForce ll_force, ll_local
end
def llSetForceAndTorque ll_force, ll_torque, ll_local
	return $objects[0].llSetForceAndTorque ll_force, ll_torque, ll_local
end
def llSetHoverHeight ll_height, ll_water, ll_tau
	return $objects[0].llSetHoverHeight ll_height, ll_water, ll_tau
end
def llSetInventoryPermMask ll_item, ll_mask, ll_value
	return $objects[0].llSetInventoryPermMask ll_item, ll_mask, ll_value
end
def llSetKeyframedMotion ll_keyframes, ll_options
	return $objects[0].llSetKeyframedMotion ll_keyframes, ll_options
end
def llSetLinkAlpha ll_linknumber, ll_alpha, ll_face
	return $objects[0].llSetLinkAlpha ll_linknumber, ll_alpha, ll_face
end
def llSetLinkCamera ll_link, ll_eye, ll_at
	return $objects[0].llSetLinkCamera ll_link, ll_eye, ll_at
end
def llSetLinkColor ll_linknumber, ll_color, ll_face
	return $objects[0].llSetLinkColor ll_linknumber, ll_color, ll_face
end
def llSetLinkMedia ll_link, ll_face, ll_params
	return $objects[0].llSetLinkMedia ll_link, ll_face, ll_params
end
def llSetLinkPrimitiveParams ll_linknumber, ll_rules
	return $objects[0].llSetLinkPrimitiveParams ll_linknumber, ll_rules
end
def llSetLinkPrimitiveParamsFast ll_linknumber, ll_rules
	return $objects[0].llSetLinkPrimitiveParamsFast ll_linknumber, ll_rules
end
def llSetLinkTexture ll_linknumber, ll_texture, ll_face
	return $objects[0].llSetLinkTexture ll_linknumber, ll_texture, ll_face
end
def llSetLinkTextureAnim ll_link, ll_mode, ll_face, ll_sizex, ll_sizey, ll_start, ll_length, ll_rate
	return $objects[0].llSetLinkTextureAnim ll_link, ll_mode, ll_face, ll_sizex, ll_sizey, ll_start, ll_length, ll_rate
end
def llSetLocalRot ll_rot
	return $objects[0].llSetLocalRot ll_rot
end
def llSetMemoryLimit ll_limit
	return $objects[0].llSetMemoryLimit ll_limit
end
def llSetObjectDesc ll_description
	return $objects[0].llSetObjectDesc ll_description
end
def llSetObjectName ll_name
	return $objects[0].llSetObjectName ll_name
end
def llSetObjectPermMask ll_mask, ll_value
	return $objects[0].llSetObjectPermMask ll_mask, ll_value
end
def llSetParcelMusicURL ll_url
	return $objects[0].llSetParcelMusicURL ll_url
end
def llSetPayPrice ll_price, ll_quick_pay_buttons
	return $objects[0].llSetPayPrice ll_price, ll_quick_pay_buttons
end
def llSetPos ll_pos
	return $objects[0].llSetPos ll_pos
end
def llSetPrimMediaParams ll_face, ll_params
	return $objects[0].llSetPrimMediaParams ll_face, ll_params
end
def llSetPrimURL ll_url
	return $objects[0].llSetPrimURL ll_url
end
def llSetPrimitiveParams ll_rules
	return $objects[0].llSetPrimitiveParams ll_rules
end
def llSetRegionPos ll_position
	return $objects[0].llSetRegionPos ll_position
end
def llSetRemoteScriptAccessPin ll_pin
	return $objects[0].llSetRemoteScriptAccessPin ll_pin
end
def llSetRot ll_rot
	return $objects[0].llSetRot ll_rot
end
def llSetScale ll_size
	return $objects[0].llSetScale ll_size
end
def llSetScriptState ll_name, ll_run
	return $objects[0].llSetScriptState ll_name, ll_run
end
def llSetSitText ll_text
	return $objects[0].llSetSitText ll_text
end
def llSetSoundQueueing ll_queue
	return $objects[0].llSetSoundQueueing ll_queue
end
def llSetSoundRadius ll_radius
	return $objects[0].llSetSoundRadius ll_radius
end
def llSetStatus ll_status, ll_value
	return $objects[0].llSetStatus ll_status, ll_value
end
def llSetText ll_text, ll_color, ll_alpha
	return $objects[0].llSetText ll_text, ll_color, ll_alpha
end
def llSetTexture ll_texture, ll_face
	return $objects[0].llSetTexture ll_texture, ll_face
end
def llSetTextureAnim ll_mode, ll_face, ll_sizex, ll_sizey, ll_start, ll_length, ll_rate
	return $objects[0].llSetTextureAnim ll_mode, ll_face, ll_sizex, ll_sizey, ll_start, ll_length, ll_rate
end
def llSetTimerEvent ll_sec
	return $objects[0].llSetTimerEvent ll_sec
end
def llSetTorque ll_torque, ll_local
	return $objects[0].llSetTorque ll_torque, ll_local
end
def llSetTouchText ll_text
	return $objects[0].llSetTouchText ll_text
end
def llSetVehicleFlags ll_flags
	return $objects[0].llSetVehicleFlags ll_flags
end
def llSetVehicleFloatParam ll_param, ll_value
	return $objects[0].llSetVehicleFloatParam ll_param, ll_value
end
def llSetVehicleRotationParam ll_param, ll_rot
	return $objects[0].llSetVehicleRotationParam ll_param, ll_rot
end
def llSetVehicleType ll_type
	return $objects[0].llSetVehicleType ll_type
end
def llSetVehicleVectorParam ll_param, ll_vec
	return $objects[0].llSetVehicleVectorParam ll_param, ll_vec
end
def llSetVelocity ll_force, ll_local
	return $objects[0].llSetVelocity ll_force, ll_local
end
def llShout ll_channel, ll_msg
	return $objects[0].llShout ll_channel, ll_msg
end
def llSin ll_theta
	return $objects[0].llSin ll_theta
end
def llSitTarget ll_offset, ll_rot
	return $objects[0].llSitTarget ll_offset, ll_rot
end
def llSleep ll_sec
	return $objects[0].llSleep ll_sec
end
def llSound ll_sound, ll_volume, ll_queue, ll_loop
	return $objects[0].llSound ll_sound, ll_volume, ll_queue, ll_loop
end
def llSoundPreload ll_sound
	return $objects[0].llSoundPreload ll_sound
end
def llSqrt ll_val
	return $objects[0].llSqrt ll_val
end
def llStartAnimation ll_anim
	return $objects[0].llStartAnimation ll_anim
end
def llStopAnimation ll_anim
	return $objects[0].llStopAnimation ll_anim
end
def llStopHover 
	return $objects[0].llStopHover 
end
def llStopLookAt 
	return $objects[0].llStopLookAt 
end
def llStopMoveToTarget 
	return $objects[0].llStopMoveToTarget 
end
def llStopPointAt 
	return $objects[0].llStopPointAt 
end
def llStopSound 
	return $objects[0].llStopSound 
end
def llStringLength ll_str
	return $objects[0].llStringLength ll_str
end
def llStringToBase64 ll_str
	return $objects[0].llStringToBase64 ll_str
end
def llStringTrim ll_src, ll_type
	return $objects[0].llStringTrim ll_src, ll_type
end
def llSubStringIndex ll_source, ll_pattern
	return $objects[0].llSubStringIndex ll_source, ll_pattern
end
def llTakeCamera ll_avatar
	return $objects[0].llTakeCamera ll_avatar
end
def llTakeControls ll_controls, ll_accept, ll_pass_on
	return $objects[0].llTakeControls ll_controls, ll_accept, ll_pass_on
end
def llTan ll_theta
	return $objects[0].llTan ll_theta
end
def llTarget ll_position, ll_range
	return $objects[0].llTarget ll_position, ll_range
end
def llTargetOmega ll_axis, ll_spinrate, ll_gain
	return $objects[0].llTargetOmega ll_axis, ll_spinrate, ll_gain
end
def llTargetRemove ll_number
	return $objects[0].llTargetRemove ll_number
end
def llTeleportAgentHome ll_avatar
	return $objects[0].llTeleportAgentHome ll_avatar
end
def llTextBox ll_avatar, ll_message, ll_chat_channel
	return $objects[0].llTextBox ll_avatar, ll_message, ll_chat_channel
end
def llToLower ll_src
	return $objects[0].llToLower ll_src
end
def llToUpper ll_src
	return $objects[0].llToUpper ll_src
end
def llTransferLindenDollars ll_destination, ll_amount
	return $objects[0].llTransferLindenDollars ll_destination, ll_amount
end
def llTriggerSound ll_sound, ll_volume
	return $objects[0].llTriggerSound ll_sound, ll_volume
end
def llTriggerSoundLimited ll_sound, ll_volume, ll_top_north_east, ll_bottom_south_west
	return $objects[0].llTriggerSoundLimited ll_sound, ll_volume, ll_top_north_east, ll_bottom_south_west
end
def llUnSit ll_id
	return $objects[0].llUnSit ll_id
end
def llUnescapeURL ll_url
	return $objects[0].llUnescapeURL ll_url
end
def llVecDist ll_vec_a, ll_vec_b
	return $objects[0].llVecDist ll_vec_a, ll_vec_b
end
def llVecMag ll_vec
	return $objects[0].llVecMag ll_vec
end
def llVecNorm ll_vec
	return $objects[0].llVecNorm ll_vec
end
def llVolumeDetect ll_detect
	return $objects[0].llVolumeDetect ll_detect
end
def llWater ll_offset
	return $objects[0].llWater ll_offset
end
def llWhisper ll_channel, ll_msg
	return $objects[0].llWhisper ll_channel, ll_msg
end
def llWind ll_offset
	return $objects[0].llWind ll_offset
end
def llXorBase64Strings ll_s1, ll_s2
	return $objects[0].llXorBase64Strings ll_s1, ll_s2
end
def llXorBase64StringsCorrect ll_str1, ll_str2
	return $objects[0].llXorBase64StringsCorrect ll_str1, ll_str2
end
